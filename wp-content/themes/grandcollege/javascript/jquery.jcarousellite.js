...
$.fn.jCarouselLite = function(o) {
    ...
    return this.each(function() {                           // Returns the element collection. Chainable.
        ...
        if(o.btnPrev)
            $(this).siblings('.jcarousellite-nav').find(o.btnPrev).click(function() {
                return go(curr-o.scroll);
            });

        if(o.btnNext)
            $(this).siblings('.jcarousellite-nav').find(o.btnNext).click(function() {
                return go(curr+o.scroll);
            });
...
jQuery(window).load(function() {
	...
	// Call jcarousellite
	var carousellite = jQuery('.jcarousellite').not('.twitter');
	...
	carousellite.each(function(){
		...
		if(jQuery(this).children().hasClass('twitter-shortcode')){
