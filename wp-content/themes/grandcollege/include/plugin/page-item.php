<?php
	...
	*/
	...
	function print_search_course($item_xml){
		...
		echo '<div class="search-attribute-title gdl-title title-color">Search By Attribute</div>';
		...
		echo '<div class="fill-keyword-title gdl-title title-color">Fill Your Keywords</div>';
